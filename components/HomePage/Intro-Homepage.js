...
const IntroHomepage = () => {
    ...
    return(
        <div className="intro-homepage-container">
            ...
            <div className="img-container-intro"><Image sizes="131.37vw" src={FlennorPartsBG} priority fill style={{objectFit: 'cover'}} alt="Flennor Parts" title="Flennor Parts" /></div>
